...
const pages: Record<string, Omit<SeoData, 'path'>> = {
  '/': { title: 'Marina Chiarelli | Cultura, territori e futuro del Piemonte', description: 'Sito personale-istituzionale di Marina Chiarelli, Assessore della Regione Piemonte. Cultura, pari opportunità, politiche giovanili e progetti sui territori.' },
  '/chi-e-marina': { title: 'Chi è Marina Chiarelli | Profilo, percorso e incarico in Regione Piemonte', description: 'Dalla Giunta comunale di Novara al ruolo in Regione Piemonte: il percorso pubblico e istituzionale di Marina Chiarelli.' },
  ...
  '/agenda': { title: 'Attività e appuntamenti | Marina Chiarelli', description: 'Iniziative pubbliche documentate legate al lavoro istituzionale di Marina Chiarelli in Piemonte.' },
